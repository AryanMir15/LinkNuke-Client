...
const Preview = () => {
  ...
  return (
    <section
      className="relative w-full overflow-hidden -mt-20 pt-20"
      id="preview"
    >
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="relative max-w-5xl mx-auto">
              {/* 16:9 Video Placeholder Rectangle */}
              <div className="relative w-full aspect-video bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-sm rounded-xl border border-[#1de4bf]/20 overflow-hidden shadow-2xl">
                ...
                <div className="relative flex items-center justify-center h-full">
                  <div className="text-center">
                    {/* Play Button */}
                    <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br from-[#1de4bf] to-[#0bf3a2] flex items-center justify-center text-black mb-4 mx-auto shadow-lg hover:scale-110 transition-transform duration-300 cursor-pointer">
                      <Play
