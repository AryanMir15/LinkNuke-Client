...
const DocumentsModal = ({ closeModal }) => {
  ...
  const validate = () => {
    ...
    if (files.length > 0 && files[0].size > MAX_DOC_SIZE_BYTES)
      errs.file = `Document must be under ${MAX_DOC_SIZE_MB}MB`;
          ...
          <div className="relative z-10">
            ...
            <div className="text-center">
              ...
              <p className="mb-6 text-gray-300/80 text-sm sm:text-base">
                Your document link is ready to share:
              </p>
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-2 mb-2">
          ...
          <InfoModal
            ...
            title="Extra Secure for Documents"
          >
            <div className="text-gray-200">
              When enabled, your document will be displayed as a secure,
              view-only image. Download, right-click, inspect, and screenshot
              are blocked for maximum privacy.
            </div>
          </InfoModal>
        </div>
